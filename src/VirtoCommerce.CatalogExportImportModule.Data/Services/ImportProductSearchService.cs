...
namespace VirtoCommerce.CatalogExportImportModule.Data.Services
{
    public class ImportProductSearchService : IImportProductSearchService
    {
        ...
        public async Task<ProductSearchResult> SearchAsync(ImportProductSearchCriteria criteria)
        {
        ...
        protected virtual IList<SortInfo> BuildSortExpression(ImportProductSearchCriteria criteria)
        {
